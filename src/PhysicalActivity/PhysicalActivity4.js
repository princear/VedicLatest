...
const PhysicalActivity4 = ({navigation}) => {
  ...
  const navigationPreviousFlow = () => {
    navigation.navigate('PhysicalActivity3');
  };
  const navigationFlow = () => {
    navigation.navigate('PhysicalActivity5');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          ...
          <View
            ...
            <QuestionText>
              On average, how many minutes do you spend on each session of
              physical activity?
            </QuestionText>
          </View>
          <View>
...
export default PhysicalActivity4;
