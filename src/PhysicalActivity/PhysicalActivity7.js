...
const PhysicalActivity7 = ({navigation}) => {
  ...
  const navigationPreviousFlow = () => {
    navigation.navigate('PhysicalActivity6');
  };
  const navigationFlow = () => {
    navigation.navigate('PhysicalActivity8');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/image_96.png')}
          ...
          <View
            ...
            <QuestionText>
              Outside your regular job, how many hours do you spend each week on
              light work?
            </QuestionText>
            <SubHeading>
              (Household repairs, gardening, house-cleaning, etc)
            </SubHeading>
          </View>
          <View>
            <Text
...
export default PhysicalActivity7;
