...
const PhysicalActivity5 = ({navigation}) => {
  ...
  const navigationPreviousFlow = () => {
    navigation.navigate('PhysicalActivity4');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/image_95.png')}
          ...
          <View
            ...
            <QuestionText>
              How much effort do you feel you normally make?
            </QuestionText>
            <SubHeading>
              (1 means very little effort and 5 means a great deal of effort)
            </SubHeading>
          </View>
          <View>
            <Text
...
export default PhysicalActivity5;
