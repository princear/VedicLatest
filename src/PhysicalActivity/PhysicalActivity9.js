...
const PhysicalActivity9 = ({navigation}) => {
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/image_98.png')}
          ...
          <View
            ...
            <QuestionText>
              How many flights of stairs do you climb each day?
            </QuestionText>
            <SubHeading>
...
export default PhysicalActivity9;
