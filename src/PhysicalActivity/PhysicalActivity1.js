...
const PhysicalActivity1 = ({navigation}) => {
  ...
  const navigationFlow = () => {
    navigation.navigate('PhysicalActivity2');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/image_93.png')}
          ...
          <View
            ...
            <QuestionText>
              On an average day, how many hours do you spend sitting?
            </QuestionText>
            <SubHeading>(Computer, TV, Leisure etc)</SubHeading>
          </View>
