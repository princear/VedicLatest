...
const PhysicalActivity2 = ({navigation}) => {
  ...
  const navigationPreviousFlow = () => {
    navigation.navigate('PhysicalActivity1');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/image_94.png')}
          ...
          <View
            ...
            <QuestionText>
              Do you regularly engage in physical activities?
            </QuestionText>
          </View>
          <View>
            <McqComponent
...
export default PhysicalActivity2;
