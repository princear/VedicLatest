...
const SleepTest8 = ({navigation}) => {
  const [click, setClick] = useState('');
  const [mcqchoice, setMcqChoice] = useState('');

  const navigationPreviousFlow = () => {
    navigation.navigate('SleepTest7');
  };
  const navigationFlow = () => {
    navigation.navigate('SleepTest9');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086674.png')}
          ...
          <View
            ...
            <QuestionText>
              How often have you had trouble sleeping because you can't breathe
              comfortably?
            </QuestionText>
