...
const SleepTest14 = ({navigation}) => {
  ...
  const navigationFlow = () => {
    navigation.navigate('SleepTest15');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          ...
          <View
            ...
            <QuestionText>
              How often have you had trouble sleeping because of any other
              reason not described above?
            </QuestionText>
