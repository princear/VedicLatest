      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086700.png')}
          ...
          <View
            ...
            <QuestionText>
              How many hours per night do you spend actually sleeping?
            </QuestionText>
