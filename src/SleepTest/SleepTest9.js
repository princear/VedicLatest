...
const SleepTest9 = ({navigation}) => {
  ...
  const navigationFlow = () => {
    navigation.navigate('SleepTest10');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/OBJECTS3.png')}
          ...
          <View
            ...
            <QuestionText>
              How often have you had trouble sleeping because you cough or snore
              loudly?
            </QuestionText>
