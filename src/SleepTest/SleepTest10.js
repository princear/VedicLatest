      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/OBJECT.png')}
          ...
          <View
            ...
            <QuestionText>
              How often have you had trouble sleeping because you feel too cold?
            </QuestionText>
