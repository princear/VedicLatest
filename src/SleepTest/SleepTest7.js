...
const SleepTest7 = ({navigation}) => {
  const [click, setClick] = useState('');
  const [mcqchoice, setMcqChoice] = useState('');

  const navigationPreviousFlow = () => {
    navigation.navigate('SleepTest6');
  };
  const navigationFlow = () => {
    navigation.navigate('SleepTest8');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086673.png')}
          ...
          <View
            ...
            <QuestionText>
              How often have you had trouble sleeping because you have to get up
              to use the bathroom?
            </QuestionText>
