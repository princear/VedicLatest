...
const SleepTest12 = ({navigation}) => {
  const [click, setClick] = useState('');
  const [mcqchoice, setMcqChoice] = useState('');

  const navigationPreviousFlow = () => {
    navigation.navigate('SleepTest11');
  };
  const navigationFlow = () => {
    navigation.navigate('SleepTest13');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086701.png')}
          ...
          <View
            ...
            <QuestionText>
              How often have you had trouble sleeping because you had bad
              dreams?
            </QuestionText>
