      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086678.png')}
          ...
          <View
            ...
            <QuestionText>
              How often have you taken medicine (prescribed or over the counter)
              to help you sleep?
            </QuestionText>
