...
const PsychlogicalNewThird = ({navigation}) => {
  ...
  const [presentation, setUsualDrink] = useState([
    {
      id: 1,
      name: 'Quickly choose what you want',
    },
    {
      id: 2,
      name: 'Ask friends for their opinions',
    },
    {
      id: 3,
      name: 'Unsure & struggle to choose',
    },
  ]);
  ...
  const navigationFlow = () => {
    navigation.navigate('PsychlogicalNewForth');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086721.png')}
          ...
          <View style={{marginTop: 30, marginBottom: 25, marginRight: 10}}>
            <QuestionText>
              You have a gift card and must decide between buying a book or a
              gadget you've wanted. Do you:
            </QuestionText>
          </View>
...
export default PsychlogicalNewThird;
