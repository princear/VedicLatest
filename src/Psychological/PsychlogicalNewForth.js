...
const PsychlogicalNewForth = ({navigation}) => {
  ...
  const [presentation, setUsualDrink] = useState([
    {
      id: 1,
      name: 'Easily choose the option',
    },
    {
      id: 2,
      name: 'Decide with your partner',
    },
    {
      id: 3,
      name: 'Feel indecisive',
    },
  ]);
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086723.png')}
          ...
          <View style={{marginTop: 30, marginBottom: 25, marginRight: 10}}>
            <QuestionText>
              You and your partner are planning a weekend getaway. The options
              are a relaxing beach resort or an adventurous mountain cabin. Do
              you:
            </QuestionText>
          </View>
...
export default PsychlogicalNewForth;
