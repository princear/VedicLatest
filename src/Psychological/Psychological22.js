...
const Psychological22 = ({navigation}) => {
  ...
  const navigationFlow = () => {
    navigation.navigate('Psychological23');
  };
  return (
    <View
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View
            ...
            {/* <Image
              source={require('../../src/assets/icons/image107.png')}
              style={styles.headingCenterImage}
            /> */}
          </View>
          <View style={{marginTop: 15, marginRight: 10}}>
            <QuestionText>
              Find out the missing tile from the options below:
            </QuestionText>
          </View>
...
export default Psychological22;
