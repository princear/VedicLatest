...
const Psychlogical26 = ({navigation}) => {
  ...
  const [presentation, setUsualDrink] = useState([
    {
      id: 1,
      name: 'Get angry and honk the horn',
    },
    {
      id: 2,
      name: 'Feel frustrated but try to control it',
    },
    {
      id: 3,
      name: 'Take deep breaths and stay calm',
    },
    {
      id: 4,
      name: 'Accept the situation & remain patient',
    },
  ]);

  const navigationPreviousFlow = () => {
    navigation.navigate('Psychlogical25');
  };
  const navigationFlow = () => {
    navigation.navigate('Psychlogical27');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/Character3.png')}
          ...
          <View style={{marginTop: 30, marginBottom: 25, marginRight: 10}}>
            <QuestionText>
              You are stuck in heavy traffic on your way to an important
              meeting. How do you react?
            </QuestionText>
          </View>
