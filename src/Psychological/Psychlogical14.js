...
const Psychlogical14 = ({navigation}) => {
  ...
  const [presentation, setUsualDrink] = useState([
    ...
    {
      id: 4,
      name: 'I feel very upset and betrayed',
    },
  ]);
  ...
  const navigationFlow = () => {
    navigation.navigate('Psychlogical15');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086724.png')}
          ...
          <View style={{marginTop: 30, marginBottom: 25, marginRight: 10}}>
            <QuestionText>
              Your friend cancels your plans at the last minute and hangs out
              with someone else. How do you feel?
            </QuestionText>
          </View>
