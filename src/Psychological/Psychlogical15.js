...
const Psychlogical15 = ({navigation}) => {
  ...
  const [presentation, setUsualDrink] = useState([
    {
      id: 1,
      name: "They don't seem interested",
    },
    {
      id: 2,
      name: 'Congratulate and nothing more',
    },
    {
      id: 3,
      name: 'They celebrate and are happy',
    },
  ]);
  ...
  const navigationFlow = () => {
    navigation.navigate('Psychlogical16');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/OBJECTS.png')}
          ...
          <View style={{marginTop: 30, marginBottom: 25, marginRight: 10}}>
            <QuestionText>
              You tell your friend about something you achieved. How do they
              react?
            </QuestionText>
          </View>
