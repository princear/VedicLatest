...
const PsychlogicalNewFifth = ({navigation}) => {
  ...
  const [presentation, setUsualDrink] = useState([
    {
      id: 1,
      name: 'Decide easily & inform others',
    },
    {
      id: 2,
      name: 'Ask the group for their preferences',
    },
    {
      id: 3,
      name: 'Struggle to decide',
    },
  ]);
  ...
  const navigationFlow = () => {
    navigation.navigate('PsychlogicalFifth');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086722.png')}
          ...
          <View style={{marginTop: 30, marginBottom: 25, marginRight: 10}}>
            <QuestionText>
              You're responsible for picking a restaurant for a group dinner.
              Some prefer Italian cuisine, while others prefer Mexican. Do you:
            </QuestionText>
          </View>
...
export default PsychlogicalNewFifth;
