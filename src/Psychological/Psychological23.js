...
const Psychological23 = ({navigation}) => {
  ...
  const navigationPreviousFlow = () => {
    navigation.navigate('Psychlogical22');
  };
  const navigationFlow = () => {
    navigation.navigate('Psychological24');
  };
  return (
    <View
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          ...
          <View style={{marginTop: 15, marginRight: 10}}>
            <QuestionText>
              Count the number of triangles with in 3 minutes.
            </QuestionText>

            <SubHeading>
              You will see an image next for 3 minutes where you have to count
...
export default Psychological23;
