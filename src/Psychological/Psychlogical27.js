...
const Psychlogical27 = ({navigation}) => {
  ...
  const [presentation, setUsualDrink] = useState([
    {
      id: 1,
      name: 'Consider firing back an angry email',
    },
    {
      id: 2,
      name: 'Feel upset but take time before replying',
    },
    {
      id: 3,
      name: 'Acknowledge emotions, reply calmly',
    },
    {
      id: 4,
      name: 'Consider the feedback and learn from it',
    },
  ]);
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086728.png')}
          ...
          <View style={{marginTop: 30, marginBottom: 25, marginRight: 10}}>
            <QuestionText>
              You receive an email from your boss criticizing a mistake you
              made. How do you handle it?
            </QuestionText>
          </View>
