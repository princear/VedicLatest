...
const Psychlogical30 = ({navigation}) => {
  ...
  const [presentation, setUsualDrink] = useState([
    {
      id: 1,
      name: 'Feel angry, blame others and vent out',
    },
    {
      id: 2,
      name: 'Feel frustrated but try to find solutions',
    },
    {
      id: 3,
      name: 'Embrace feelings, focus on solutions',
    },
    {
      id: 4,
      name: 'Confirm your opinion, and ask for help',
    },
  ]);
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086730.png')}
          ...
          <View style={{marginTop: 30, marginBottom: 25, marginRight: 10}}>
            <QuestionText>
              You encounter a series of unfortunate events on a special day. How
              do you handle it?
            </QuestionText>
          </View>
