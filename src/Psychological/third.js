...
const PsychlogicalThird = ({navigation}) => {
  ...
  const navigationFlow = () => {
    navigation.navigate('PsychlogicalNewSixth');
  };
  return (
    <View
      ...
      <View style={{marginLeft: 10}}>
        ...
        <ScrollView contentContainerStyle={{paddingBottom: 60}}>
          <View style={{marginTop: Platform.OS == 'web' ? '30%' : '10%'}}>
            ...
            <View style={{marginTop: 17}}>
              <Text style={styles.statementLeftHeading}>
                2. Tentacles digest the food a jellyfish eats.
              </Text>
            ...
            <View style={{marginTop: 17}}>
              <Text style={styles.statementLeftHeading}>
                3. Jellyfish breathe through gills.
              </Text>
            ...
            <View style={{marginTop: 17}}>
              <Text style={styles.statementLeftHeading}>
                4. Jellyfish usually live in freshwater.
              </Text>
