...
const Psychlogical17 = ({navigation}) => {
  ...
  const [presentation, setUsualDrink] = useState([
    ...
    {
      id: 2,
      name: 'It bothers me a bit',
    },
    {
      id: 3,
      name: "I wish they'd initiate conversations too",
    },
    {
      id: 4,
      name: "I feel unnoticed, wish they'd reach out",
    },
  ]);
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086726.png')}
          ...
          <View style={{marginTop: 30, marginBottom: 25, marginRight: 10}}>
            <QuestionText>
              You usually start conversations with your friend. How do you feel
              about this?
            </QuestionText>
          </View>
