...
const Psychlogical28 = ({navigation}) => {
  ...
  const [presentation, setUsualDrink] = useState([
    {
      id: 1,
      name: 'Get angry and confront the person',
    },
    {
      id: 2,
      name: 'Feel annoyed & make a remark',
    },
    {
      id: 3,
      name: 'Take a deep breath and stay calm',
    },
    {
      id: 4,
      name: 'Reassure the person & move on',
    },
  ]);
  ...
  const navigationFlow = () => {
    navigation.navigate('Psychlogical29');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/Group26086824.png')}
          ...
          <View style={{marginTop: 30, marginBottom: 25, marginRight: 10}}>
            <QuestionText>
              Someone accidentally spills a drink on your new outfit at a
              crowded event. How do you react?
            </QuestionText>
          </View>
