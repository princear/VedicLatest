      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/image128.png')}
          ...
          <View
            ...
            <QuestionText>
              How often have you felt on top of things in the last month?
            </QuestionText>
