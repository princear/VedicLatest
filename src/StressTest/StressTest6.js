...
const StressTest6 = ({navigation}) => {
  const [click, setClick] = useState('');
  const [mcqchoice, setMcqChoice] = useState('');

  const navigationPreviousFlow = () => {
    navigation.navigate('StressTest5');
  };
  const navigationFlow = () => {
    navigation.navigate('StressTest7');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/image126.png')}
          ...
          <View
            ...
            <QuestionText>
              How frequently have you struggled to cope up with your
              responsibilities?
            </QuestionText>
