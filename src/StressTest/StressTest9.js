...
const StressTest9 = ({navigation}) => {
  const [click, setClick] = useState('');
  const [mcqchoice, setMcqChoice] = useState('');

  const navigationPreviousFlow = () => {
    navigation.navigate('StressTest8');
  };
  const navigationFlow = () => {
    navigation.navigate('StressTest10');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/image129.png')}
          ...
          <View
            ...
            <QuestionText>
              How many times have you been enraged by events that were beyond
              your control?
            </QuestionText>
