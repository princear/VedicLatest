...
const StressTest1 = ({navigation}) => {
  ...
  const navigationFlow = () => {
    navigation.navigate('StressTest2');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '20%'}}>
            <Image
              source={require('../../src/assets/icons/image121.png')}
              style={styles.headingCenterImage}
            />
          </View>

          <View
            style={{marginTop: '30%', marginBottom: '15%', marginRight: 10}}>
            <QuestionText>
              How frequently have unexpected events made you upset?
            </QuestionText>
