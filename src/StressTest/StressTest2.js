...
const StressTest2 = ({navigation}) => {
  const [click, setClick] = useState('');
  const [mcqchoice, setMcqChoice] = useState('');

  const navigationPreviousFlow = () => {
    navigation.navigate('StressTest1');
  };
  const navigationFlow = () => {
    navigation.navigate('StressTest3');
  };
      ...
      <View style={{marginLeft: 10}}>
        ...
        <View>
          <View style={{alignItems: 'center', marginTop: '10%'}}>
            <Image
              source={require('../../src/assets/icons/image122.png')}
          ...
          <View
            ...
            <QuestionText>
              How often did you feel unable to control significant elements in
              your life?
            </QuestionText>
